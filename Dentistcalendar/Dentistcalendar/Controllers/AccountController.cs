...
namespace Dentistcalendar.Controllers
{
    ...
    {
        private UserManager<AppUser> _userManager;//kullanıcıları belirleyecegimiz
        private RoleManager<AppRole> _roleManager;// rolleri belirleyeceğimiz
        private SignInManager<AppUser> _signInManager;

        public AccountController(UserManager<AppUser> userManager, 
            SignInManager<AppUser> signManager, RoleManager<AppRole> roleManager)
        {
        ...
        public IActionResult Register(RegisterViewModel model)
        {
            ...
            if (result.Succeeded)// kullanıcı dişci ise ona göre rol ekle dişci olup olmadıgı addRole metodu il ekontrol ediliyor
            {
